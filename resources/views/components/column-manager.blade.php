        ...
        return {
            ...
            async applyTableColumnManager() {
                ...
                try {
                    ...
                    await this.$wire.callSchemaComponentMethod(this.repeaterKey, 'applyTableColumnManager', [this.columns]);
                } catch (error) {
                    this.error = error;
                ...
                :attributes="
                    \Filament\Support\prepare_inherited_attributes(
                        new ComponentAttributeBag([
                            'color' => 'danger',
                            'tag' => 'button',
                            'x-on:click' => 'resetColumns(); $wire.callSchemaComponentMethod(repeaterKey, \'resetTableColumnManager\', [])',
